...
export default function LoginPage() {
  ...
  const [email, setEmail] = useState("demo@typebuilder.com");
  ...
  return (
    <div className="min-h-screen bg-black text-white flex items-center justify-center p-6">
      <div className="w-full max-w-md bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-md">
        ...
        <div className="bg-purple-500/10 border border-purple-500/30 text-purple-300 p-4 rounded-xl mb-6 text-sm">
          <strong>Demo Mode:</strong> The hackathon demo credentials have been pre-filled for the judges. Just click Sign In!
        </div>
